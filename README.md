...
4. `src/content/news/YYYY-MM-DD-daily-briefing.md` 파일을 생성합니다.
5. 신규 글과 seen URL 기록을 커밋합니다.
6. Astro 사이트를 빌드해서 GitHub Pages에 배포합니다.

논문 섹션은 제목, 요약, 논문 링크만 남기도록 구성했습니다.
...
자동 수집 워크플로는 커밋과 배포를 같은 워크플로 안에서 처리합니다.
