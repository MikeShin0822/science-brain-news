...
`.github/workflows/daily-news.yml`이 매일 09:30 KST에 실행됩니다.
...
6. 같은 workflow 안에서 Astro 사이트를 빌드하고 route verification을 통과한 뒤 GitHub Pages에 배포합니다.

뉴스 글은 확장 요약, 왜 중요한가, 읽을 때 주의할 점, 원문 링크 중심으로 구성합니다.
논문 글은 긴 요약, 읽을 때 볼 점, 논문 링크 중심으로 구성합니다.
